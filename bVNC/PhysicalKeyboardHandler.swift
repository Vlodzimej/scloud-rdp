    ...
    init(stateKeeper: StateKeeper) {
        ...
        if #available(iOS 13.4, *) {
            self.specialKeyToXKeySymMap = [
                ...
                UIKeyCommand.inputUpArrow: XK_Pointer_Up,
                UIKeyCommand.inputDownArrow: XK_Pointer_Down,
                UIKeyCommand.inputLeftArrow: XK_Pointer_Left,
                UIKeyCommand.inputRightArrow: XK_Pointer_Right,
                "\u{1E}": XK_Pointer_Up,
